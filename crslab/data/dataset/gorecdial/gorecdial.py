    ...
    def _raw_data_process(self, raw_data):
        ...
        Returns:
            list of dict: {
                ...
                'interaction_history' (list of int): id of items which have interaction with user in current turn;
